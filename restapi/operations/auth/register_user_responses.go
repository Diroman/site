...
/*RegisterUserOK successful operation
...
func (o *RegisterUserOK) WithPayload(payload *models.Token) *RegisterUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the register user o k response
func (o *RegisterUserOK) SetPayload(payload *models.Token) {
	o.Payload = payload
}
...
/*RegisterUserInternalServerError Server error
