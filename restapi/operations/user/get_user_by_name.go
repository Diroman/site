...
type GetUserByNameHandlerFunc func(GetUserByNameParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetUserByNameHandlerFunc) Handle(params GetUserByNameParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetUserByNameHandler interface for that can handle valid get user by name params
type GetUserByNameHandler interface {
	Handle(GetUserByNameParams, interface{}) middleware.Responder
}
...
/* GetUserByName swagger:route GET /user/info user getUserByName
